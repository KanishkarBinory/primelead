            ...
            <a
              ...
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => {
                if (!isActiveChild) {
                  ...
                  e.currentTarget.style.color = "#1a8fa8";
                }
              }}
              ...
              return (
                ...
                >
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2.5 rounded-xl no-underline whitespace-nowrap cursor-pointer transition-all duration-150 relative"
                    style={{
                      fontSize: "15.5px",
                  ...
                  {item.children ? (
                    <>
                      <button
                        ...
                        onClick={() =>
                          setMobileAccordion((v: string | null) =>
                            v === item.label ? null : item.label
                          )
                        }
                        className="flex items-center justify-between w-full px-4 py-3.5 mb-0.5 bg-transparent border-none cursor-pointer text-left rounded-xl transition-colors"
                        style={{
                          fontSize: "15.5px",
                          fontWeight: 500,

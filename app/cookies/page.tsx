const CookiePage = () => {
  return (
    <main className="min-h-screen bg-white">
      {/* Header */}
      <div className="px-10 pt-16 pb-0 max-w-[1200px] mx-auto">
      ...
      {/* Body Content */}
      <div className="px-10 pt-10 pb-20 max-w-[1200px] mx-auto">
        {/* Dates */}
        ...
        <section className="mb-10">
          ...
          <a
            ...
            className="text-teal-500 text-sm font-medium hover:underline block mb-4"
          >
            Cookie Settings
          </a>

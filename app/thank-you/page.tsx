      ...
      >
        ...
        <div className="w-full max-w-2xl mx-auto text-center">
          ...
          >
            ...
            >
              We&apos;ve received your enquiry and one of our advisors will be in
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ marginBottom: '40px' }}>
              {[
                ...
                { step: '02', title: 'Contact', desc: 'An advisor reaches out within 24 hours.' },
                { step: '03', title: 'Guidance', desc: 'We guide you through your next steps.' },
              ].map((item) => (
                <div
                  key={item.step}
                  style={{
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
              <Link
                ...
                style={{ backgroundColor: '#1a8fa8', fontSize: '15px', fontWeight: 600 }}
              >
                Back to Home
              </Link>
              <Link
